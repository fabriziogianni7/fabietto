...
func TestRunSubagents_OrderPreserved(t *testing.T) {
	...
	a := New(client, "You are helpful.", 0, toolSet, convStore, "", nil)
...
func TestSubagents_NoWalletTools(t *testing.T) {
	...
	walletTools := []string{"wallet_get_balance", "wallet_erc20_balance", "wallet_execute_transfer", "wallet_execute_erc20_transfer", "wallet_execute_erc20_approve", "wallet_execute_contract_call", "wallet_list_transactions"}
